...
public class Robot extends TimedRobot {
    ...
    public static OI oi_mate;
    // BEGIN AUTOGENERATED CODE, SOURCE=ROBOTBUILDER ID=DECLARATIONS
    public static ArcadeDrive arcadeDrive;
    public static WallE wallE;
    public static WallEHand wallEHand;
    public static Eve eve;
    public static TractorBeam tractorBeam;
    ...
    public void robotInit() {
        ...
        //chooser.setDefaultOption("Autonomous Command", new ArcadeDrive());
    ...
    public void teleopPeriodic() {
        Scheduler.getInstance().run();
        double y_axis=oi_mate.joy.getY(Hand.kLeft);
        double x_axis=oi_mate.joy.getX(Hand.kRight);
        ...
        arcadeDrive.axium.curvatureDrive(y_axis, x_axis, true);
    }
}
