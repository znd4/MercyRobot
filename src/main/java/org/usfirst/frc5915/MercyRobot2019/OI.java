...
public class OI {
    ...
    public RightTrigger rightTriggerButton;
    public LeftTrigger leftTriggerButton;
    ...
    public OI() {
        ...
        rightTriggerButton = new RightTrigger(joy);
        rightTriggerButton.whileActive(new LowerArm(joy));
        leftTriggerButton = new LeftTrigger(joy);
